...
namespace DataAccess.Migrations
{
    ...
    [Migration("20251201185143_addFluent_ManyToManyRelationMapping_ManulTable")]
    partial class addFluent_ManyToManyRelationMapping_ManulTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Models.Fluent_Book", b =>
                {
                    b.HasOne("Model.Models.Fluent_Publisher", "Publisher")
                        .WithMany("Books")
                        .HasForeignKey("Publisher_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.Models.Fluent_BookAuthorMap", b =>
                {
                    b.HasOne("Model.Models.Fluent_Author", "Author")
                        .WithMany("BookAuthorMap")
                        .HasForeignKey("Author_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Model.Models.Fluent_Book", "Book")
                        .WithMany("BookAuthorMap")
                        .HasForeignKey("IDBook")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Model.Models.Fluent_BookDetail", b =>
                {
                    b.HasOne("Model.Models.Fluent_Book", "Book")
                        .WithOne("BookDetail")
                        .HasForeignKey("Model.Models.Fluent_BookDetail", "IDBook")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
